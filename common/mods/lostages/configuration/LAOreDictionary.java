...
public class LAOreDictionary {
	...
	public static void init() {
		...
		OreDictionary.registerOre("oreAdamant", new ItemStack(Blocks.oreBase, 1, 2));
		...
		OreDictionary.registerOre("ingotStrongGold", new ItemStack(Items.ingotBase, 1, 5));
		OreDictionary.registerOre("ingotAdamant", new ItemStack(Items.ingotBase, 1, 6));
	}
