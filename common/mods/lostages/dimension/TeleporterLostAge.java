...
public class TeleporterLostAge extends Teleporter {
	...
	public TeleporterLostAge(WorldServer par1WorldServer) {
	...
	public boolean placeInExistingPortal(Entity par1Entity, double par2, double par4, double par6, float par8) {
		...
		if (var10 >= 0.0D) {
			...
			if (var50 > -1) {
				...
				if (var36 && var37) {
					var50 = Direction.facingToDirection[var50];
					var31 = Direction.facingToDirection[var31];
				...
				if (var50 == var30) {
					var40 = 1.0F;
					var41 = 1.0F;
				} else if (var50 == Direction.facingToDirection[var30]) {
					var40 = -1.0F;
					var41 = -1.0F;
				} else if (var50 == Direction.facingToDirection[var30]) {
					var42 = 1.0F;
