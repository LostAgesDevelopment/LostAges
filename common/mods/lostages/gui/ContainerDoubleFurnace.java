...
public class ContainerDoubleFurnace extends Container {
	...
	public ContainerDoubleFurnace(InventoryPlayer inventoryPlayer, TileDoubleFurnace tileFurnace) {
		...
		this.addSlotToContainer(new Slot(tileFurnace, 0, 26, 17));
		this.addSlotToContainer(new Slot(tileFurnace, 1, 64, 17));
		this.addSlotToContainer(new Slot(tileFurnace, 2, 45, 53));
